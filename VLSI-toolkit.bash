...
sudo apt update
sudo apt install build-essential python3 python3-venv python3-pip python3-tk ca-certificates curl make git gedit mesa-utils x11-apps x11-utils bison flex tcl-dev tk tk-dev libxpm4 libxpm-dev xterm -y
